...
import org.batchitemwiter.gson.impl.processor.PersonItemProcessor;
...
public class BatchConfiguration extends DefaultBatchConfigurer {
 ...
 // tag::readerwriterprocessor[]
    ...
    public ItemWriter<Person> writer(DataSource dataSource) {
       ...
       writer.setResource(new FileSystemResource(System.getProperty("user.dir") + File.separator  + "src/main/resources/json-sample-output-data.json"));
